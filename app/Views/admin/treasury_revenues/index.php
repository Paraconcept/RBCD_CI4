...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-arrow-up mr-2"></i>Recettes — <?= $monthNames[$month] ?> <?= $year ?></h3>
    </div>
    <div class="card-body p-0">
        <?php if (empty($rows)): ?>
            <div class="p-3 text-muted"><i class="fas fa-info-circle mr-1"></i>Aucune recette enregistrée pour <?= $monthNames[$month] ?> <?= $year ?>.</div>
        <?php else: ?>
