...
<head>
  ...
  <title>Confirmation d'inscription à l'arbitrage</title>
  <style>
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <p>Ton inscription comme <strong>arbitre</strong> a bien été enregistrée pour la rencontre suivante :</p>
      ...
      <div class="detail-box">
        ...
        <p><strong>Lieu :</strong>
          <?php if ($encounter->is_home): ?>
            À domicile (Dison)
          <?php else: ?>
            À l'extérieur<?= $encounter->venue ? ' — ' . esc($encounter->venue) : '' ?>
          <?php endif; ?>
        </p>
        <?php if ($encounter->encounter_type === 'finale' && $round > 0): ?>
          <p><strong>Tour :</strong> Tour <?= $round ?></p>
        <?php endif; ?>
      </div>
