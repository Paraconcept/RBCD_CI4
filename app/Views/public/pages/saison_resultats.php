...
<section class="section-padding">
  <div class="container">
      ...
      <div class="col-md-10 col-lg-8 mx-auto mb-40">
        <div class="tm-sc-heading">
          ...
          <p class="heading-description text-center text-dark mt-20">
            Palmarès des joueurs du RBC Disonais (vainqueurs et finalistes) des coupes et championnats, de la saison <strong><?= esc($season) ?></strong>.
          </p>
        </div>
      </div>
    </div>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="heading-season">
              <button class="accordion-button" type="button"
                      data-bs-toggle="collapse" data-bs-target="#season-panel"
                      aria-expanded="true" aria-controls="season-panel">
            ...
            <div id="season-panel" class="accordion-collapse collapse show"
                 aria-labelledby="heading-season" data-bs-parent="#resultsAccordion">
              <div class="accordion-body py-0 px-0">
                ...
                <div class="text-center text-muted py-40">
                  ...
                  <p>Aucun résultat enregistré pour la saison <?= esc($season) ?>.</p>
                </div>
                <?php else: ?>
                <ul class="sr-list">
    ...
    <div class="row mt-20">
      <div class="col-12 text-center">
        <a href="<?= base_url('archives/resultats') ?>" class="btn-sr-archives">
          <i class="fas fa-archive me-2"></i>Voir toutes les saisons précédentes
        </a>
      </div>
    </div>
...
.btn-sr-archives:hover { background: #84252B; color: #fff; }
